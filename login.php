...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset ('assets/dist/img/logo.jpeg') }}">
  <title>Login | PT. QUALITA INDONESIA</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">

  <link rel="shortcut icon" href="<?= base_url() ?>/assets/dist/img/logo.jpeg">
  <!-- Font Awesome -->
  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="login-logo">
        <br>
        <h3>
          <img class="img-circle elevation-2" src="<?= base_url() ?>/assets/dist/img/logo.jpeg" style="margin-top: 20px; margin-bottom: 20px;" width="150px;" height="140px;">
        <h2 style="color:blue; font-family: system-ui;"><b>PT. QUALITA INDONESIA</b><br></h2>
          
      </div>
      <div class="card-body login-card-body" style="background-color: dodgerblue;">
        ...
        <form action="" method="POST">
          ...
          <button type="submit" name="login" class="btn btn-default btn-block bg-gradient-blue btn-xm"><i class="fa fa-sign-in-alt mr-1"></i>Masuk</button>
          <br>
        </form>
